...
const App = () => {
  ...
  const images = [
    { src: '/th_images/demo_1.jpg', answer: 'robot', clue: 'Its the superhero that keeps your digital world safe from bad guys.' },
    { src: '/th_images/demo_2.jpg', answer: 'pc', clue: 'This is Wireless connection Technology to transfer the files.' },
    { src: '/th_images/demo_3.jpg', answer: 'jira', clue: 'Its like a game where you can design, customize, and command your very own.' },
    { src: '/th_images/demo_4.jpg', answer: 'db', clue: 'Its like a game where you can design, customize, and command your very own.' },
  ];
